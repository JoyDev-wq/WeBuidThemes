    ...
    <div className='px-[5rem] xl:px-[15rem] py-[5rem] bg-[#f5f5f5]'>
      <div className="flex flex-col justify-center items-center">
        <div className="text-center ">
            ...
            <p className='text-2xl text-[#7c7c7c]'>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
        </div>
        <div className="flex flex-wrap justify-center mt-[5rem] gap-[2rem]">
            <div className="w-[25rem] md:w-[23rem] px-[2rem] py-[2rem] flex flex-col justify-center items-center gap-[3rem] bg-white shadow-xl rounded-md">
